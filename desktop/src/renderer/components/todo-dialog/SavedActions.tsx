...
// The saved-stage top-right chrome: the ⋯ overflow menu (Raw/Formatted · Copy
// task path · Archive · Delete — harvested from TaskDialog's menu) and the ✕.
// Rendered above the title, never sharing its line (KRN-0). Capture is
// chrome-free, so the shell mounts this only in the saved stage.
